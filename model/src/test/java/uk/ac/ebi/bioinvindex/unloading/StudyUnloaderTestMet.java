...
/*
 * To test with maven:
 * mvn clean test -Dtest=StudyUnloaderTestMet -Pindex,h2,index_local -DargLine="-Xms128m -Xmx512m" -e -DfailIfNoTests=false
 * change oracle to whatever profile id you wish to test.
 */

public class StudyUnloaderTestMet extends TransactionalDBUnitEJB3DAOTest
{

	public StudyUnloaderTestMet () throws Exception {
		super ();
	}
	...
	protected void prepareSettings() {
		...
		dataSetLocation = "test_unloading_met.xml";
	}
